...
print("Poprawnosc dla knn = 3: " + str(knn3_score))
knn3_matrix = confusion_matrix(test_classes, knn3.predict(test_inputs))
print("Macierz bledu dla knn = 3")
print(knn3_matrix)
...
y = [decision_tree_score, knn3_score, knn7_score, knn11_score, gnb_score]
